...
import {initAdmin} from "../../backend/index.js"
...
export async function confirmOTP(code) {
    ...
    // const getNameSlow = async () => {
    //     setTimeout(() => {return 'Nitya'}, 3000)
    // };

    // try {

    //     const name = await getNameSlow();
    // } catch (err) {
    //     console.error(err)
    // }
    
    // const name = getNameSlow().then((response) => {return response}).catch(error => console.error(error))